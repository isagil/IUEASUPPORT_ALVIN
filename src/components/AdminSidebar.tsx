...
import { LayoutDashboard, Ticket, BookOpen, Building2, LogOut } from "lucide-react";
  ...
  return (
    <aside className="flex h-screen w-60 flex-col bg-sidebar text-sidebar-foreground">
      <div className="flex items-center gap-2 border-b border-sidebar-border px-5 py-5">
        ...
        <div>
          <div className="font-display text-lg font-bold">SupBot</div>
          <div className="text-[10px] uppercase tracking-wider opacity-70">Admin Panel</div>
        </div>
      </div>
